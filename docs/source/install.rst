...
Download the `deb <https://github.com/jethornton/mesact/raw/master/mesact_0.6.4_amd64.deb>`_

Or use wget from a terminal
::

	wget https://github.com/jethornton/mesact/raw/master/mesact_0.6.4_amd64.deb
